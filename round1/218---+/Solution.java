...
public class Solution {
    public List<int[]> getSkyline(int[][] buildings) {
        ...
        if (buildings == null || buildings.length == 0)
            return result;
        // create points array, every beign and end of a building would be a point
        ...
        // for every point, if addition / remove of the point lead to the change of heap root, put it into result. 
        for (Point p : points) {
            if (p.isStart) {
